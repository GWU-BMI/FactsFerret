...
public enum Field {
	DOCUMENT_TEXT, DOCUMENT_TYPE, DIAGNOSIS, ENCOUNTER_YEAR, MEDICATION, SURGICAL_PROCEDURE, CLINICAL_EVENT, CARESETTING_SID, AGE, GENDER, COUNTY, STATE, VISN, ICD9DESCRIPTION, ICD9CODE, DRUGS, PATIENT_SID, PATIENT_ICN, DOCUMENT_ID, CPT, DECEASED, STOPCODE, LAB;
